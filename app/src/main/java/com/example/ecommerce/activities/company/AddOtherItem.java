...
public class AddOtherItem extends AppCompatActivity {
    ...
    private String categoryName, itemID, itemName, itemDescription, itemSize = "noSize", itemGender, itemQuantityString, itemColor, itemPicture, itemSeller;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.child(companyID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AddOtherItem.this, "Server error, please try again." , Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void validateItemData(){
        itemID = itemIdInput.getText().toString() + "-nosize";
        ...
        if(ImageUri == null){
            Toast.makeText(AddOtherItem.this, "Please upload item image", Toast.LENGTH_LONG).show();
        }
    ...
    private void storeItemData() {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AddOtherItem.this, "Error: "+message, Toast.LENGTH_LONG).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AddOtherItem.this, "File uploaded successfully.", Toast.LENGTH_LONG).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AddOtherItem.this, "Image uploaded successfully.", Toast.LENGTH_LONG).show();
                            saveItemToDatabase();
                        }
                    }
                });
